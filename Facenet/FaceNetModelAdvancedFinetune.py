...
class FaceNetModelAdvancedFinetune:
    def __init__(self, model_dir="../inception-v3"):
        ...
        for layer in self.model.signatures['serving_default'].structured_outputs:
            print(f"Layer name: {layer}")
            print(self.model.signatures['serving_default'].structured_outputs[layer])
