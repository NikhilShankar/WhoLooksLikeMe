...
class InceptionV3SingleHead:
    def __init__(self, dataset_dir, embedding_dimension=128):
        """
        ...
        x = base_model.output
        print(f"Model Shape at Base output layer {x.shape}")
        #Reshaped the flattened layer for using conv2d layer again
        ...
        print(f"Model Shape at Additional Conv2d 1 {x.shape}")
        x = layers.Conv2D(filters=4, kernel_size=5, activation="relu")(x)
        print(f"Model Shape at Additional Conv2d 5 {x.shape}")
