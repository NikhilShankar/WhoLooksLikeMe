...
#A new version of the model with changed set of augmentation hyoerparameters only


class ResNet50SingleHead:
    ...
    def train_model(self, epochs=10, batch_size=32):
        ...
        train_datagen = ImageDataGenerator(rescale=1./255, 
                                           rotation_range=45,
                                           width_shift_range=0.33, #Halved
                                           height_shift_range=0.33, #Halved
                                           zoom_range=0.33, #kept this the same
