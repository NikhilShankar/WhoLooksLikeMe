...
class SimilarityCalculatorAdvancedCorrected2:
    def __init__(self, embeddings_dir):
        ...
        self.datagen = ImageDataGenerator(
            ...
            brightness_range=(0.9,1.1),     # Flip images randomly horizontally
            fill_mode='constant'         # How to fill missing pixels after transformations
        )
    ...
    def calculate_similarity(self, test_image_path, model, topN=5, num_iterations=10):
        ...
        img = load_img(test_image_path, target_size=self.input_size)
        img = img_to_array(img)  # Convert image to array
        img = img / 255.0 
